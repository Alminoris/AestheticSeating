...
public class ModLanguageProviderEsEs extends FabricLanguageProvider
{
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup wrapperLookup, TranslationBuilder translationBuilder)
    {
        ...
        stoneFurniture.put("stone_bench", "Banco de %s");
        ...
        translationBuilder.add("item." + AestheticSeating.MOD_ID + ".cushion_remover", "Quitacojines");
        translationBuilder.add("item." + AestheticSeating.MOD_ID + ".wrench", "Llave inglesa");
