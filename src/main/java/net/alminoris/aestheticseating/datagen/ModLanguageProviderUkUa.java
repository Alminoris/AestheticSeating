...
public class ModLanguageProviderUkUa extends FabricLanguageProvider
{
    ...
    public void generateTranslations(TranslationBuilder translationBuilder)
    {
        ...
        translationBuilder.add("item." + AestheticSeating.MOD_ID + ".cushion_remover","Знімач подушок");
        translationBuilder.add("item." + AestheticSeating.MOD_ID + ".wrench","Гайковий ключ");
