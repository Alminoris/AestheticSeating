...
public class ModLanguageProviderDeDe extends FabricLanguageProvider
{
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup wrapperLookup, TranslationBuilder translationBuilder)
    {
        ...
        stoneFurniture.put("stone_bench", "Bank aus %s");
        ...
        translationBuilder.add("item." + AestheticSeating.MOD_ID + ".cushion_remover", "Kissenentferner");
        translationBuilder.add("item." + AestheticSeating.MOD_ID + ".wrench", "Schraubenschlüssel");
