...
public class SimpleBench extends SeatingFurniture
{
    ...
    protected ItemActionResult onUseWithItem(ItemStack stack, BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit)
    {
        ...
        if ((!currentBackrest) && (stack.isIn(TagKey.of(RegistryKeys.ITEM, Identifier.of("aestheticseating", "wrench")))) && (Block.getBlockFromItem(player.getOffHandStack().getItem()) != null))
        {
            if (!world.isClient)
            {
